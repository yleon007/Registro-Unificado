...
public class FPRedFlag  implements java.io.Serializable {
    ...
    /**
     * Gets the name value for this FPRedFlag.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this FPRedFlag.
     * 
     * @param name
     */
    ...
    /**
     * Gets the riskIndicators value for this FPRedFlag.
     * 
    ...
    /**
     * Sets the riskIndicators value for this FPRedFlag.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FPRedFlag)) return false;
        FPRedFlag other = (FPRedFlag) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FPRedFlag.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bridgerinsight.lexisnexis.com/BridgerInsight.Web.Services.Interfaces.9.0", "FPRedFlag"));
