...
public class GenderType implements java.io.Serializable {
    ...
    public static final GenderType None = new GenderType(_None);
    public static final GenderType Female = new GenderType(_Female);
    public static final GenderType Male = new GenderType(_Male);
    public static final GenderType Unknown = new GenderType(_Unknown);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bridgerinsight.lexisnexis.com/BridgerInsight.Web.Services.Interfaces.9.0", "GenderType"));
    }
    /**
